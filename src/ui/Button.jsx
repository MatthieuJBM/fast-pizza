...
function Button({ children, disabled, to, type }) {
  const base = `inline-block rounded-full bg-yellow-400 font-semibold
  ...
  const styles = {
    ...
    secondary: `inline-block rounded-full border-2 border-stone-300 bg-transparent 
    px-4 py-2.5 font-semibold uppercase 
    ...
    focus:ring-offset-2 disabled:cursor-not-allowed md:px-6 
    md:py-3.5`,
  };
