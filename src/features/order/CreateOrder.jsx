    ...
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              className="w-full rounded-full border border-stone-200 px-4
        ...
        <div>
          ...
          <button
            ...
            className="inline-block rounded-full bg-yellow-400 px-4
             py-3 font-semibold uppercase tracking-wide text-stone-800
